...
db <- 'db_name'  # provide the name of your db
host_db <- 'localhost' #i.e. # i.e. 'ec2-54-83-201-96.compute-1.amazonaws.com' or localhost 
db_port <- '9999'  # or any other port specified by the DBA (5432 is common)
db_user <- "username" # provide the username to log into DB
db_password <- "password" # Provide password
